        ...
        {menuOptions.map((item) =>
          item.dropdown ? (
            <div
              key={item.text}
              className="navbar-dropdown relative"
              onMouseEnter={item.text === "Offerings" ? handleOpenOfferingsDropdown : handleOpenServicesDropdown}
              onMouseLeave={item.text === "Offerings" ? handleCloseOfferingsDropdown : handleCloseServicesDropdown}
            >
              <Link to={item.text === "Offerings" ? "/offerings" : "/services"} className="text-gray-800 hover:text-blue-500">
                {item.text}
              </Link>
